...
arguments:
  ...
  - position: 0
    ...
    valueFrom: >
      ${
        var setup = "vcf=\"" + inputs.input_vcf + "\";\n";
        setup += "idx=\"" + inputs.input_vcf_index + "\";\n";
        return setup;
      }
  - position: 9
    shellQuote: false
...
inputs:
  # Required Inputs
  input_vcf: { type: string, doc: "VCF files to concat, sort, and optionally index" }
  input_vcf_index: {type: string}
